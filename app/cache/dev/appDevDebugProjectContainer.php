...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_project_transversale', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\RecommandationBundle\\Entity'))), 'RecommandationBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('RecommandationBundle' => 'RecommandationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2646fcc0a65149ddfb6a19226492ff6621f114072c391d4b1a27c87f485b1e6f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TransversaleBundle/Resources/views'), 'Transversale');
        $instance->addPath(($this->targetDirs[3].'\\src\\RecommandationBundle/Resources/views'), 'Recommandation');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bb0a0a664649.88173173')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TransversaleBundle' => 'TransversaleBundle\\TransversaleBundle',
                'RecommandationBundle' => 'RecommandationBundle\\RecommandationBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'TransversaleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TransversaleBundle'),
                    'namespace' => 'TransversaleBundle',
                ),
                'RecommandationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RecommandationBundle'),
                    'namespace' => 'RecommandationBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => NULL,
            'database_name' => 'my_project_transversale',
            'database_user' => 'root',
